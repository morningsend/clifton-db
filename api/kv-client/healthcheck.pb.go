...
func init() {
	proto.RegisterEnum("kv_client.HealthCheckResponse_ServingStatus", HealthCheckResponse_ServingStatus_name, HealthCheckResponse_ServingStatus_value)
	proto.RegisterType((*HealthCheckRequest)(nil), "kv_client.HealthCheckRequest")
	proto.RegisterType((*HealthCheckResponse)(nil), "kv_client.HealthCheckResponse")
}
...
var fileDescriptor_9ce162ac01966b78 = []byte{
	...
	0x29, 0xc9, 0x48, 0xce, 0x48, 0x4d, 0xce, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0xcc,
	0x2e, 0x8b, 0x4f, 0xce, 0xc9, 0x4c, 0xcd, 0x2b, 0x51, 0xd2, 0xe3, 0x12, 0xf2, 0x00, 0xcb, 0x3b,
	0x83, 0xe4, 0x83, 0x52, 0x0b, 0x4b, 0x53, 0x8b, 0x4b, 0x84, 0x24, 0xb8, 0xd8, 0x8b, 0x53, 0x8b,
	...
	0x26, 0x24, 0x8b, 0xcb, 0x11, 0x60, 0x5f, 0x4a, 0xc9, 0xe1, 0x77, 0xa3, 0x93, 0xc0, 0x89, 0x47,
	0x72, 0x8c, 0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78, 0x24, 0xc7, 0x38, 0xe3, 0xb1, 0x1c, 0x43, 0x12,
	0x1b, 0x38, 0xfc, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xaf, 0x87, 0x6c, 0xda, 0x54, 0x01,
	0x00, 0x00,
}
...
func (c *healthClient) Check(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kv_client.Health/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Health_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kv_client.Health/Check",
	}
